...
<!--**********************************
        ...
        ***********************************-->
        ...
        <div class="content-body" style="text-align: center; padding: 200px 20px;">
            <img src="{{ asset('storage/dashboard/assets/images/avatar/services-home.jpg') }}" alt="Bannière" style="width: 100%; max-height: 400px; object-fit: cover; margin-bottom: 30px;">

            <div>
                <a href="{{ route('demandes.index') }}" class="btn" style="padding: 10px 20px; font-size: 16px; background-color: blue; color: white; border: none; border-radius: 5px;">
                    Voir les demandes
                </a>
            </div>
        </div>
