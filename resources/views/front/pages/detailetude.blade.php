    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2>@lang('index.study_loan')</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('front.pages.index') }}">@lang('header.home')</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('index.study_loan')</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-8 col-lg-9">
                <div class="services-details">
                    <div class="services-thumb-lg">
                        <img src="{{ asset('storage/front/asset/img/services-education.jpg') }}" alt="">
                    </div>

                    <p>@lang('index.service_details_text_3') </p>

                    <p>@lang('index.service_details_inner_text_3')</p>
                    <div class="row">
                        <div class="col-md-6">
