    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2>@lang('index.auto_loan')</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('front.pages.index') }}">@lang('header.home')</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('index.auto_loan')</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-8 col-lg-9">
                <div class="services-details">
                    <div class="services-thumb-lg">
                        <img src="{{ asset('storage/front/asset/img/services-car.jpg') }}" alt="">
                    </div>

                    <p>@lang('index.auto_loan_description1') </p>

                    <p>@lang('index.auto_loan_description2')</p>
                    <div class="row">
                        <div class="col-md-6">
